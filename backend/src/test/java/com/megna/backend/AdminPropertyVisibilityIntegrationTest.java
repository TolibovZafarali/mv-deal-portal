...
class AdminPropertyVisibilityIntegrationTest {
    ...
    @Test
    void sellerSubmitShouldTransitionDraftAndMakeListingVisibleToAdmin() throws Exception {
        String adminToken = createAdminAndLogin();
        String sellerEmail = "seller.transition@example.com";
        String sellerPassword = "SellerPass123!";
        long sellerId = seedSeller(sellerEmail, sellerPassword);
        long propertyId = seedProperty("Seller Draft Transition", sellerId, "DRAFT", "DRAFT");
        ...
        mockMvc.perform(post("/api/seller/properties/{id}/submit", propertyId)
